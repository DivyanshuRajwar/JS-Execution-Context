...
const Button = ({ label, onClick }) => {
  return (
    <button onClick={onClick} className="w-[80%] relative overflow-hidden rounded-xl bg-gradient-to-b from-gray-700 to-gray-900 p-[2px] text-white font-bold text-lg cursor-pointer transition-transform duration-300 hover:scale-105">
